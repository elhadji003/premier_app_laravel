...
<div class="min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('app_login') }}" method="POST" class="mt-6">
            @csrf
            <!-- Email Input -->
        ...
        <div class="mt-4 text-center">
            <p class="text-sm text-gray-500">
                Vous n'avez pas encore de compte ? <a href="{{ route('app_register_form') }}" class="text-gray-500 hover:underline">Créer un compte</a>
            </p>
        </div>
    </div>
</div>
